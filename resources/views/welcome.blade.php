    ...
    <nav class="z-[1] absolute top-8 left-0 w-full flex justify-center items-center">
        <div class="w-full mx-20 rounded-full">
            ...
            <div class="float-right py-2 mx-5 flex flex-row">
                ...
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="hidden lg:block relative text-xs text-white py-2 ml-6 uppercase group">
                            Dashboard
                            <div class="absolute left-0 top-full w-0 h-0.5 bg-white rounded-full group-hover:w-full duration-300 ease-in-out"></div>
                        </a>
                    @else
                        ...
                        <a href="{{ route('register') }}" class="hidden lg:block relative text-xs text-white py-2 ml-6 uppercase group">
                            S'enregistrer
                            <div class="absolute left-0 top-full w-0 h-0.5 bg-white rounded-full group-hover:w-full duration-300 ease-in-out"></div>
                        </a>
                        @endif

                        <a href="{{ route('login') }}" class="relative ml-6 group flex justify-center items-center  py-2 px-4 border border-white bg-white rounded-lg group">
